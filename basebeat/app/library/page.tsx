...
export default function LibraryPage() {
    ...
    return (
        <div className="p-12 bg-[#0b0e14] min-h-screen text-white font-sans selection:bg-green-500/30">
            ...
            {savedSongs.length === 0 ? (
                <div className="border border-gray-800/60 bg-[#12161f] rounded-xl p-24 text-center">
                    <span className="text-5xl block mb-5 animate-pulse">🎵</span>
                    <h3 className="text-sm font-black text-gray-300 tracking-wide">아직 등록된 커스텀 응원가가 없습니다.</h3>
                    <p className="text-xs text-gray-500 mt-2">AI COMPOSING STUDIO에서 여러분만의 첫 응원가를 생성해 보세요!</p>
                </div>
            ) : (
